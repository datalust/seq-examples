...
seqsvr node setup --cluster-listen ws://localhost:5344 --internal-api http://localhost --peer-cluster ws://seq1:5344 --peer-internal-api http://seq1 -k "verysecretkey" --node-name seq2
